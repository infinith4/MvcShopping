	...
	$(function() {
		...
		try {
			...
			if(window.XDomainRequest){
				echo 'XDomainRequestdesu';
			}else if(window.XmlHttpRequest){
				echo 'XmlHttpRequestdesu';
			}
			*/
			...
			*/
			...
			$('div.wpcf7 > form').ajaxForm({
				...
				/*CHANGE TUTIHASI*/
				dataType: 'json',
				//dataType: (window.navigator.userAgent.toLowerCase().indexOf('msie')!=-1) ? '' : 'json',
				/*KOKOMADE*/
				
				/*ADD TUTIHASI*/
				forceSync: (window.navigator.userAgent.toLowerCase().indexOf('msie')!=-1) ? true : false,
				//forceSync: (userAgent.indexOf('msie')!=-1) ? true : false,
				...
				*/
				...
				/*CHANGE TUTIHASI*/
				//success: (window.navigator.userAgent.indexOf('msie')!=-1) ? function(){} : function(data){
